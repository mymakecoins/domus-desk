...
return [
    ...
    'settings' => [
        ...
        'merge' => [
            ...
            'orig_thread_html_help'=> 'As above, plus a self-contained HTML copy of each original ticket attached to the merged one — handy when you need to hand a complete record to somebody outside Domus Desk.',
        ...
        'intros' => [
            ...
            'mailboxes'       => 'Mailboxes connect Domus Desk to email accounts so incoming messages become tickets and replies go back out — add and authenticate the ones your service desk monitors.',
        ...
        'sla' => [
            ...
            'intro'                  => 'Business-hours-aware SLAs with per-priority response and resolution targets. The clock pauses on statuses flagged "Pauses SLA" on the <a href="#" onclick="event.preventDefault();switchTab(\'statuses\');">Statuses tab</a>. See <a href="https://github.com/mymakecoins/domus-desk/blob/main/docs/sla.md" target="_blank">design notes</a>.',
    ...
    'help' => [
        ...
        'faster' => [
            ...
            'merge_body'    => 'Two people reported the same outage? Select the tickets, right-click, <strong>Merge</strong>. The conversations come together, and if you have an AI provider configured Domus Desk writes a short briefing of what everyone asked and what has already been done, so whoever picks it up does not have to read four threads.',
        ...
        'settings' => [
            ...
            'email_body'    => 'The email import feature connects to your shared mailbox and pulls in new messages as tickets. When an end user sends an email to your support address (e.g. support@yourcompany.com), Domus Desk creates a ticket with the email subject as the title and the email body as the description. If the sender replies to a notification email, the reply is threaded into the existing ticket rather than creating a duplicate.',
            ...
            'email_step2'   => '<strong>Set polling interval</strong> &mdash; choose how frequently Domus Desk checks the mailbox for new messages. Shorter intervals mean faster ticket creation.',
    ...
    'help_sla' => [
        ...
        'overview' => [
            'heading' => 'Overview',
            'sub'     => 'What SLAs are, why they matter, and how the Domus Desk engine works at a high level.',
            'p1'      => 'A Service Level Agreement (SLA) is a promise about how quickly your team will respond to and resolve a ticket. Domus Desk tracks two clocks per ticket: <strong>response</strong> (time from ticket creation to first analyst action) and <strong>resolution</strong> (time from ticket creation to ticket closure). Both targets are set per priority &mdash; so a P1 might have 30 minutes for response and 4 hours for resolution, while a P4 might have 8 working hours and 5 working days.',
            'p2'      => 'Domus Desk\'s SLA engine has four design choices worth understanding:',
        ...
        'cron' => [
            ...
            'p2'      => 'The script is <span class="tk-help-code">cron/sla_breach_check.php</span> in the Domus Desk install directory. It can be invoked two ways:',
        ...
        'trouble' => [
            ...
            'tip'  => 'For an in-depth technical walkthrough of cron setup including Linux examples and remote-scheduler integration, see <span class="tk-help-code">docs/sla-cron-setup.md</span> in the Domus Desk install directory.',
        ],
    ],
];
